...
class ElasticsearchBridgeTest extends \PHPUnit_Framework_TestCase
{
    /**
     * Parse test
     */
...
// JCSDL_MASTER_END';
        ...
        $expected = '{"query":{"query_string":{"query":"(bitly.geo_city:(Chicago) OR bitly.domain:\"espn.com\") AND bitly.timezone:\"America\/Los_Angeles\""}}}';
        $this->assertEquals($expected, json_encode($elasticsearchQuery->toArray()));
